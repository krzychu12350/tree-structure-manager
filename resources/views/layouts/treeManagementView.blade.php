                                ...
                                <div class="col-md-4">
                                    <div class="container">
                                        <ul class="nav nav-pills">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="add-tab" data-bs-toggle="pill"
                                                   href="#tab-pane">Add</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="edit-tab" data-bs-toggle="pill"
                                                   href="#tab-edit">Edit</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="delete-tab" data-bs-toggle="pill"
                                                   href="#tab-delete">Delete</a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <form id="addCategoryForm" class="needs-validation">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                   for="selectParentAdd">Parent</label>
                                            ...
                                            <div class="tab-pane container fade p-0" id="tab-edit">
                                                <div class="mt-4">
                                                    ...
                                                    <form id="editCategoryForm" class="needs-validation">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                   for="selectParentEdit">Parent</label>
                                                            <select class="form-select parent-select"
                                                                    id="selectParentEdit"
                                                                    aria-label="Default select example">
                                                        ...
                                                        <button type="submit" id="editCategory" class="btn btn-primary">
                                                            Edit
                                                        </button>
                                                    </form>
                                                </div>
                                                    ...
                                                    <form id="deleteCategoryForm" class="needs-validation">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   id="readonlyInputNameForDelete" value="Name..."
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                   for="readonlyInputParentForDelete">Parent</label>
                                                            <input type="text" class="form-control"
                                                                   id="readonlyInputParentForDelete"
                                                                   value="Parent name..." aria-label="Parent name..."
                                                                   readonly>
                                                            <div class="invalid-feedback">Please enter a valid email
                                                                address.
                                                            </div>
                                                        </div>
                                                        <button type="submit" id="deleteCategory"
